...
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/pinecone-router@7.5.1?labelColor=%23d7f4ee&style=flat&color=%230b2822&&logo=bun&logoColor=%230b2822)](https://bundlephobia.com/result?p=pinecone-router@7.5.1)
<br>
...
```html
<script src="https://cdn.jsdelivr.net/npm/pinecone-router@7.5.1/dist/router.min.js"></script>
```
...
```javascript
import PineconeRouter from 'https://cdn.jsdelivr.net/npm/pinecone-router@7.5.1/dist/router.esm.js'
